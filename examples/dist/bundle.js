	...
	renderInput: function renderInput(valueArray, focusedOptionIndex) {
		...
		if (this.props.inputRenderer) {
			...
			var inputProps = _extends({}, this.props.inputProps, {
				...
				'aria-describedby': isOpen ? null : this.props.multi ? valueArray.map(function (value, i) {
					return _this3._instancePrefix + '-value-' + i;
				}).join(' ') : this._instancePrefix + '-value-item',
				className: className,
